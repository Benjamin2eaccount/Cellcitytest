(function(){
    ...
    window.CELLCITY_CATALOGUS = {
        categories: ["Telefoons","iPads & Tablets"],
        brands: ["Apple","Samsung","Sony","Huawei","LG","OnePlus"],
        services,
        devices
    };
})();
